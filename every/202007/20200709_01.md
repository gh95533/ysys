...
### one 无法使用kitchen调用资源库作业

```
# ./kitchen.sh /res:SPOON4 /user:admin /pass:admin /job:SJSC_JZKK_F_ZYK_T_TL_KKYPSJ
...
​	这两天依然遇到了该问题，不过是在windows上面，又整理了一下方法

[Kitchen can't continue because the job couldn't be loaded](../202012/20201217_01.md)





### two:linux环境下使用kettle的table input控件，无法在sql栏中点击，点击后整个程序退出
...
### three 生产环境下gpload控件更新时，无法选择YES
