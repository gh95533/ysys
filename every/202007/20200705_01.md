...
​             该方案中有三个job,三个trans，如果可以更优化的的话

    

[CENTER_FTP_COPY_ROWS_TO_RESULT.ktr](../../mirror/CENTER_FTP_COPY_ROWS_TO_RESULT.ktr)

[CENTER_FTP_RESULT_VARIABLE_SYSTEM_DOWNLOAD.kjb](../../image/CENTER_FTP_RESULT_VARIABLE_SYSTEM_DOWNLOAD.kjb)

[CENTER_FTP_SET_VARIABLE_NO_REMOTEDIR.ktr](../../mirror/CENTER_FTP_SET_VARIABLE_NO_REMOTEDIR.ktr)

[CENTER_FTP_STSTEN_DOWNLOAD.kjb](../../mirror/CENTER_FTP_STSTEN_DOWNLOAD.kjb)

[CENTER_FTP_VARIABLE_SYSTEM_DOWNLOAD.kjb](../../mirror/CENTER_FTP_VARIABLE_SYSTEM_DOWNLOAD.kjb)

[CENTER_SYSTEM_INFO.ktr](../../mirror/CENTER_SYSTEM_INFO.ktr)
