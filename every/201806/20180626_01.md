...
# kettle cluster 5.4 install on centos 6
...
2018-06-26,2020-09-20

**label**

kettle,cluster,5.4,centos,6
...
现在这个时代都要对软件进行分布式操作，如此研究一下kettle集群的搭建
...
[linux uninstall openjdk](20180626_03.md)
...
[master]#  vim carte-config-master-8080.xml 
<slave_config>
...
[slave1]# vim carte-config-8081.xml 
<slave_config>
...
[slave2]# vim  carte-config-8082.xml 
...
[Kettle Database Repository](20180615_03.md)
...
![_](../../image/2018-06-26_kettle_1.png)

![_](../../image/2018-06-26_kettle_2.png)

![_](../../image/2018-06-26_kettle_3.png)

- 在 kettle cluster schemas 中选择新建NEW,并在出现的界面选择右下方的“SELECT slave servers”,选择保存

![_](../../image/2018-06-26_kettle_4.png)

![_](../../image/2018-06-26_kettle_5.png)

- 正式新建方案，选择SORT column控件，并在右击找到"clustering"下的选择集群组名，当前是C1

![_](../../image/2018-06-26_kettle_11.png)

![_](../../image/2018-06-26_kettle_12.png)
