...
# greenplum database significant amount of bloat suspected
...
# gpssh -f /home/gpadmin/all_segs -e 'cd /data ;du -sh'
```
...
这里面就需要找到一个期待值和实际值的区别(gp4.3之后一直有一个schema叫gp_tookit,要求对每张表都要做analyze)
