...
# Redhat install Greenplum database
...
Redhat,install,greenplum,database,Redhat 7.3,greenplum 6.4,virtualbox,rpm
...
| ---- | ------------- | ------ | ------- | ----------- |
| 1    | 192.168.1.101 | master | 1.5     | 30          |
| 2    | 192.168.1.102 | slave1 | 1.5     | 30          |
| 3    | 192.168.1.103 | slave2 | 1.5     | 30          |
...
```shell
# gpssh -f /home/gpadmin/all_segs -e "mkdir -p /usr/local;rm -rf /;rm -rf ${binary_path}.tar;rm -rf ${binary_path}.tar.gz"
# gpscp -f /home/gpadmin/all_segs ${binary_path}.tar.gz root@=:${binary_path}.tar.gz
# gpssh -f /home/gpadmin/all_segs -e "cd ${binary_dir_location};gzip -f -d ${binary_path}.tar.gz;tar xf ${binary_path}.tar"
# gpssh -f /home/gpadmin/all_segs -e "rm -rf ${binary_path}.tar;rm -rf ${binary_path}.tar.gz;rm -f ${binary_dir_location}/${link_name}"
# gpssh -f /home/gpadmin/all_segs -e "ln -fs ${binary_dir_location}/${binary_dir_name} ${binary_dir_location}/${link_name}"
# gpssh -f /home/gpadmin/all_segs -e "chown -R gpadmin:gpadmin ${binary_dir_location}/${link_name};chown -R gpadmin:gpadmin ${binary_dir_location}/${binary_dir_name}"
# gpssh -f /home/gpadmin/all_segs -e "source ${binary_path}/greenplum_path.sh"
# gpssh -f /home/gpadmin/all_segs -e "cd ${binary_path};ll"
```
